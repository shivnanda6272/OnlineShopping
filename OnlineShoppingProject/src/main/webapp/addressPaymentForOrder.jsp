...
<title>Home</title>
<script>
if(window,histry.forward(1)!=null)
	window.histry.farward(1)
</script>
</head>
<body>
<br>
...
<div class="right-div">
<h3>Pay online on this telangesv@pay.com</h3>
...
<button class="button" type="submit"> Proceed to Generate a Bill & Save <i class='far fa-arrow-alt-circle-right'></i></button>
